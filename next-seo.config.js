const seoConfig = {
    contact: {
      ...
      openGraph: {
        ...
        type: "website",
        images: [{ url: "https://yourdomain.com/preview-contact-image.jpg" }],
      },
    },
    offers: {
    ...
    topProducts: {
      ...
      openGraph: {
        ...
        images: [{ url: "https://yourdomain.com/preview-top-products-image.jpg" }],
      },
    },
    conditions: {
      ...
      openGraph: {
        ...
        images: [{ url: "https://yourdomain.com/preview-conditions-image.jpg" }],
      },
    },
    allProducts: {
      ...
      openGraph: {
        ...
        images: [{ url: "https://yourdomain.com/preview-all-products-image.jpg" }],
      },
    },
  };
